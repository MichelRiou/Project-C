            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    foreach ($products as $product) {
                        ?>
                        <tr><td><?= $product->getProduct_imp_builder_ref() ?></td><td><?= $product->getProduct_imp_model() ?></td><td><?= $product->getProduct_imp_builder() ?></td><td><?= $product->getProduct_imp_ean() ?></td><td><?= $product->getProduct_imp_designation() ?></td>
                            <td>
