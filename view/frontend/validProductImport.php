    ...
    <div class="table-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-sm-2 form-group">
                ...
                <input class="form-control input-sm" type="text" name="builderRef" value="<?= $product->getProduct_imp_builder_ref() ?>" readonly="readonly" />
            </div>
            <div class="col-sm-6 form-group">
                <input class="form-control input-sm" type="text" name="ref" value="<?= $product->getProduct_imp_ref() ?>" />
            </div>
            <div class="col-sm-4 form-group">
                <input class="form-control input-sm" type="text" name="four" value="<?= $product->getProduct_imp_four() ?>" />
            </div>  
            </div>   
